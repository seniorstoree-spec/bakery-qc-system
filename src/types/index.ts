...
export interface MetalDetectorRecord { id:string; sn:number; time:string; machineCode:string; feStatus:'pass'|'fail'; nfeStatus:'pass'|'fail'; ssStatus:'pass'|'fail'; feCriticalMm?:number; nfeCriticalMm?:number; ssCriticalMm?:number; isCompliant:boolean; responsiblePerson:string; correctiveAction?:string; verifiedBy?:string; date:string; }
...
export interface ProductWeightSpecRecord { id:string; productName:string; time:string; doughWeight:number; doughWeightMin:number; doughWeightMax:number; bakedWeight:number; bakedWeightMin:number; bakedWeightMax:number; filledWeight?:number; filledWeightMin?:number; filledWeightMax?:number; finishedWeight:number; finishedWeightMin:number; finishedWeightMax:number; doughWeightTime?:string; bakedWeightTime?:string; filledWeightTime?:string; finishedWeightTime?:string; isCompliant:boolean; date:string; }