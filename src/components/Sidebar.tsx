...
import { 
  ...
  ShieldAlert, Sparkles, FileCheck, ChevronLeft, X, Scale
} from 'lucide-react';
...
const PRODUCT_WEIGHTS_URL = 'https://lovable.dev/projects/86d6ce56-4eb8-4abf-a977-55719a395d4d';
        ...
        <div className="p-4 space-y-1.5 overflow-y-auto flex-1 custom-scrollbar">
          ...
          <div className="pt-2 mt-2 border-t border-slate-100 dark:border-slate-800">
            <button
              ...
              className="w-full text-right p-3 rounded-2xl transition-all flex items-center gap-3 group text-slate-700 dark:text-slate-300 hover:bg-indigo-50 dark:hover:bg-indigo-950/30 hover:text-indigo-700 dark:hover:text-indigo-300 font-medium border border-transparent hover:border-indigo-200 dark:hover:border-indigo-900/60"
